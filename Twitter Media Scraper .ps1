            ...
            if([System.IO.File]::Exists("C:\TEMP\INSTALLERS\$((@(@($r.ParsedHtml.getElementsByTagName("A")).Where({$_.href -match "-x64.msi"}) | % href).ForEach({$_ -replace "about:","https://7-zip.org/"})[0]).split("/")[-1])")){
                $p = [System.Diagnostics.Process]@{
                    StartInfo = [System.Diagnostics.ProcessStartInfo]@{
                        ...
                        Arguments = " /i `"$($FILE)`" INSTALLDIR=C:\TEMP\BIN\7-Zip\ MSIINSTALLPERUSER=1 /qb /norestart";
                    }
                }
                $null = $p.Start()
                $PrID = $p.Id
                "Installing 7-zip" | WaitFor -PROCESSID $PrID
            }
            if([System.IO.File]::Exists("C:\TEMP\BIN\7-Zip\7z.exe")){
                write-host "Installed 7-zip here: " -ForeGroundColor Yellow -NoNewLine
                write-host "C:\TEMP\BIN\7-Zip\7z.exe" -foregroundcolor green
                return "C:\TEMP\BIN\7-Zip\7z.exe"
            }
        } else {
            Write-Host "7-zip is already installed here: " -ForegroundColor Yellow -NoNewLine
            if([System.IO.File]::Exists("C:\Program Files\7-Zip\7z.exe")){
                write-host "C:\Program Files\7-Zip\7z.exe" -ForegroundColor green
                            ...
                            if(!$DLLPATH){
                                ...
                                if(!$DLLPATH){
                                    ...
                                    if(!$NONUGET){
                                        ...
                                        if($reqasm){
                                            $DLLPATH = Install-DotNet_nupkg -Uri "https://www.nuget.org/packages/$($ASMNAME)/" -PATH7Z $7ZEXE
...
"@
    ...
    {
        param()
        $command = ""
    ...
    function Install-DotNet_nupkg
    {
        ...
        $FILE = "C:\TEMP\BIN\PSTwitter-Media-Scraper\$($DLLINK.Split('/')[-2..-1] -join '.').nupkg"
        $FOLDER = "C:\TEMP\BIN\PSTwitter-Media-Scraper\$($DLLINK.Split('/')[-2..-1] -join '.')\"
        if([System.IO.Directory]::Exists($FOLDER)){
            Remove-Item $FOLDER -Recurse -Force -ea 0
        }
        if([System.IO.File]::Exists($FILE)){
